...
R> 
R> ## Need to combine multiple time curves along variables.
R> pbc_ggPart <- combine(ggPrtl, ggPrtl.3, labels=c("1 Year", "3 Years"))
\end{Sinput}
\end{Schunk}
...
\caption[Risk adjusted Survival]{Risk adjusted Survival\label{fig:pbc-partial-panel}}
\end{figure}
\end{Schunk}
