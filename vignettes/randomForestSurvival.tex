...
\begin{Schunk}
\begin{Sinput}
R> plot(ggrf, xvar = xvar[-1], panel = TRUE, 
+      se=FALSE, alpha=.3, 
...
\begin{Schunk}
\begin{Sinput}
R> data(partial_coplots_pbc, package="ggRandomForests")
R> ggpl <- ggplot(partial_coplots_pbc, aes(x=bili, y=yhat, 
+                                           shape=group, 
+                                           color=group))+
