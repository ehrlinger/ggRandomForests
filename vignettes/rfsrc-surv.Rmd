...
We then graphically examine forest variable interactions with the use of variable and partial dependence conditioning plots (coplots) [@chambers:1992; @cleveland:1993] (\autoref{conditional-dependence-plots}) and the analogous partial dependence surfaces (\autoref{partial-plot-surfaces}) before adding concluding remarks in \autoref{conclusion}.
