...
## ----plot_gg_survival, fig.cap="Kaplan--Meier pbc data survival estimates comparing the DPCA treatment (red) with placebo (blue). Median survival with shaded 95\\% confidence band.", echo=TRUE----
plot(gg_dta) +
