...
This document is a package vignette for the [ggRandomForests](http://CRAN.R-project.org/package=ggRandomForests) package for Visually Exploring Random Forests. [ggRandomForests](http://CRAN.R-project.org/package=ggRandomForests)  will help uncover variable associations in the random forests models. The package is designed for use with the [randomForestSRC](http://CRAN.R-project.org/package=randomForestSRC) package for survival, regression and classification forests and uses the [ggplot2](http://CRAN.R-project.org/package=ggplot2) package for plotting diagnostic and variable association results. [ggRandomForests](http://CRAN.R-project.org/package=ggRandomForests) is  structured to extract data objects from [randomForestSRC](http://CRAN.R-project.org/package=randomForestSRC) objects and provides S3 functions for printing and plotting these objects.

This document is a tutorial for using the [randomForestSRC](http://CRAN.R-project.org/package=ggRandomForests) package for building and post-processing a regression random forest, as well as for the [ggRandomForests](http://CRAN.R-project.org/package=ggRandomForests) package for investigating how the forest is constructed. In this tutorial, we will use the [Boston Housing Data](#data), available in the [MASS](http://CRAN.R-project.org/package=MASS) package, to grow a [random forest for regression](#rfr) and demonstrate how [ggRandomForests](http://CRAN.R-project.org/package=ggRandomForests) can be used in this type of analysis.
...
The latest version of this vignette is available within the [ggRandomForests](http://cran.r-project.org/web/packages/ggRandomForests/index.html) package on the Compreshensive R Archive Network ([CRAN](http://cran.r-project.org)). A [development version of the ggRandomForests](https://github.com/ehrlinger/ggRandomForests) package is available on [Github](https://github.com) at (https://github.com/ehrlinger/ggRandomForests).
...
Once the [ggRandomForests](http://cran.r-project.org/web/packages/ggRandomForests/index.html) package has been installed into R, the vignette can also be viewed with the following command:
