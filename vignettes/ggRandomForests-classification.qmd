...
structure is well-understood enough that any strange behaviour stands out.
...
is essentially never *setosa*. If you want the same kind of curve for
*versicolor* or *virginica* instead, `shap_dependence()` is the tool that
lets you pick.
...
forest separates it well, even with the overlap versicolor. *setosa*'s ROC
