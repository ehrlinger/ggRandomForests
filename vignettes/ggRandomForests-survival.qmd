...
```{r partial-dep, fig.height=5, fig.cap="Partial dependence of survival at approximately 1 and 3 years on continuous predictors."}
...
```{r plotly-surface, fig.cap="Interactive partial dependence surface: survival as a function of bilirubin and albumin."}
