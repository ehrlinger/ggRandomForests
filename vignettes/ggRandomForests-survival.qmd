...
[@Ishwaran:RFSRC:software:2026] provides a unified implementation for survival,
...
For a publication-ready layout with custom color scale, access `pd$continuous`
directly:
...
```{r pd-surface, error=TRUE, fig.height=5, fig.cap="Partial dependence surface: survival at 1 year as a function of bilirubin and albumin. Fill color is the predicted survival probability."}
