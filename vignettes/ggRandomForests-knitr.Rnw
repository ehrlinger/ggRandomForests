...
<<iris-rf-plot, echo=FALSE, fig.cap="Classification Forest: Predicted probability of IRIS class.", fig.width=5>>=
...
<<air1-rf-plot, echo=FALSE, results=FALSE, fig.cap="Regression forest: Predicted Ozone level.">>=
...
<<surv-rf-plot, echo=FALSE, fig.cap="Survival Forest: Predicted probability of IRIS class.", fig.width=5>>=
