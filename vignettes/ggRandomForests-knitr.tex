...
\begin{verbatim}
       ...
       Average no. of terminal nodes: 8.791
...
{\centering \includegraphics[width=\maxwidth]{figure/beamer-iris-rf-plot-1} 

}

\caption[Classification Forest]{Classification Forest: Predicted probability of IRIS class.\label{fig:iris-rf-plot}}
\end{figure}
...
\begin{verbatim}
       ...
       Average no. of terminal nodes: 17.78
No. of variables tried at each split: 2
              Total no. of variables: 5
                            Analysis: RF-R
                              Family: regr
                      Splitting rule: regr
                % variance explained: 76.09
                          Error rate: 260.2
\end{verbatim}
\end{kframe}\begin{figure}[!htpb]


{\centering \includegraphics[width=\maxwidth]{figure/beamer-air1-rf-plot-1} 

}

\caption[Regression forest]{Regression forest: Predicted Ozone level.\label{fig:air1-rf-plot}}
\end{figure}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{verbatim}
R> veteran_rf <- rfsrc(Surv(time, status) ~ ., data = veteran, ntree = 100)
R> 
R> # Plot predicted survival probabilities for the training data
R> plot.gg_rfsrc(veteran_rf)
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\begin{verbatim}
       ...
       Average no. of terminal nodes: 34.9
...
\caption[Survival Forest]{Survival Forest: Predicted probability of IRIS class.\label{fig:surv-rf-plot}}
\end{figure}
