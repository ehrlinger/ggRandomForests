...
<<rfsrc-plot, fig.cap="Freedom from pump thrombosis">>=
...
<<mindepth-plot, fig.cap="Minimal Depth Plot">>=
...
<<rfsrc-plot3Mnth, echo=TRUE,fig.cap="Freedom From Pump Thrombosis">>=
ggRFsrc +
  geom_vline(aes(xintercept=364.25), linetype="dashed")+
  coord_cartesian(x=c(0,3*364.25))
@

<<variable-plotbili, echo=TRUE, fig.cap="Freedom From Pump Thrombosis at 3 months">>=
...
<<variable-plotAlbumin, echo=TRUE, fig.cap="Survival at 1 year">>=
...
<<variable-plotProthrombin, echo=TRUE, fig.cap="Survival at 1 year">>=
plot(ggrf, x_var = "prothrombin") +
  ...
  scale_shape_manual(values=event.marks, labels=event.labels)
@
<<variable-plotCopper, echo=TRUE, fig.cap="Survival at 1 year">>=
plot(ggrf, x_var = "copper") +
  ...
  scale_shape_manual(values=event.marks, labels=event.labels)
@
<<variable-plotAge, echo=TRUE, fig.cap="Survival at 1 year">>=
plot(ggrf, x_var = "age") +
  theme(legend.position="none")+
...
<<pbc-partial-bili, echo=TRUE, fig.cap="Risk adjusted freedom From Pump Thrombosis at 3 months">>=
