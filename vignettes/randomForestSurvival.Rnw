...
pbc_prtl_bili_age <- gg_partial_coplot(pbc_rf, x_var="bili", 
                                       groups=age_grp, 
                                       surv_type="surv", 
                                       time=1, 
                                       show.plots=FALSE)
...
pbc_prtl_bili_albumin <- gg_partial_coplot(pbc_rf, x_var="bili", 
                                       groups=albumin_grp, 
                                       surv_type="surv", 
                                       time=1, 
                                       show.plots=FALSE)
...
pbc_prtl_bili_prothrombin <- gg_partial_coplot(pbc_rf, x_var="bili", 
