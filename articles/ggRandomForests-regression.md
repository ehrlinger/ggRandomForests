...
```
    ...
    #>        Average no. of terminal nodes: 66.81
    ...
    #>                      (OOB) R squared: 0.86263445
    #>    (OOB) Requested performance error: 11.61930219
...
The threshold is 3, selecting 4 variables: crim, nox, rm, lstat.
