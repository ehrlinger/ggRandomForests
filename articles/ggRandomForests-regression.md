...
```
    ...
    #>        Average no. of terminal nodes: 67.02
    ...
    #>                      (OOB) R squared: 0.86192759
    #>    (OOB) Requested performance error: 11.67909266
...
The threshold is 3.03, selecting 6 variables: crim, nox, rm, dis,
ptratio, lstat.
