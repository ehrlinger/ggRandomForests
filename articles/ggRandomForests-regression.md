...
```
    ...
    #>        Average no. of terminal nodes: 66.895
    ...
    #>                      (OOB) R squared: 0.86680188
    #>    (OOB) Requested performance error: 11.26679242
...
The threshold is 2.98, selecting 6 variables: crim, nox, rm, dis,
ptratio, lstat.
