...
```
    ...
    #>        Average no. of terminal nodes: 66.72
    ...
    #>                      (OOB) R squared: 0.86607633
    #>    (OOB) Requested performance error: 11.32816475
...
The threshold is 2.99, selecting 5 variables: crim, nox, rm, ptratio,
lstat.
