...
```
    ...
    #>        Average no. of terminal nodes: 67.47
    ...
    #>                      (OOB) R squared: 0.86126298
    #>    (OOB) Requested performance error: 11.73530963
...
The threshold is 3.01, selecting 5 variables: nox, rm, dis, ptratio,
lstat.
