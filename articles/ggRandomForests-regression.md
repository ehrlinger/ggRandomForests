...
```
    ...
    #>        Average no. of terminal nodes: 66.765
    ...
    #>                      (OOB) R squared: 0.86373165
    #>    (OOB) Requested performance error: 11.52649363
...
The threshold is 3.02, selecting 5 variables: crim, nox, rm, ptratio,
lstat.
