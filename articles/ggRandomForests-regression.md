...
```
    ...
    #>        Average no. of terminal nodes: 67.18
    ...
    #>                      (OOB) R squared: 0.86619633
    #>    (OOB) Requested performance error: 11.31801432
...
The threshold is 2.98, selecting 5 variables: crim, nox, rm, ptratio,
lstat.
