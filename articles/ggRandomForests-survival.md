...
The
[`max.subtree()`](https://www.randomforestsrc.org//reference/max.subtree.rfsrc.html)
function computes minimal depth for each variable. The threshold is 5.8,
selecting 9 variables: age, ascites, edema, bili, chol, albumin, copper,
sgot, prothrombin.
...
a grid of 5 albumin values, each evaluated at 25 bilirubin points.
