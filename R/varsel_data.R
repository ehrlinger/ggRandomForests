...
#'  
#' Data sets storing \code{\link[randomForestSRC]{var.select}} objects 
...
#'   
#' @details 
#' Constructing minimal depth variable selection with the 
#' randomForestSRC::var.select function is computationally expensive. We cache 
#' \code{\link[randomForestSRC]{var.select}} objects to improve the 
...
#' selection with \code{\link[randomForestSRC]{var.select}} function, setting 
#' \code{method="md"}. Each data set is built with the 
#' \code{\link{cache_rfsrc_datasets}} with the \code{randomForestSRC} version 
#' listed in the \code{ggRandomForests} DESCRIPTION file.
#' 
#' \itemize{
#' \item \code{varsel_iris} - The famous (Fisher's or Anderson's) \code{iris} 
...
#' 
#' \item \code{varsel_pbc} - The \code{pbc} data from the Mayo Clinic trial in 
