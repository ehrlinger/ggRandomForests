...
#' \item \code{partial_pbc_time} - from a randomForest[S]RC for the \code{pbc} 
#' data set (\code{randomForestSRC} package)
#' }
#'   
#' @details 
#' Constructing partial plot data with the randomForestSRC::plot.variable 
#' function are computationally expensive. We cache 
#' \code{\link[randomForestSRC]{plot.variable}} objects to improve the 
...
#' \code{\link[randomForestSRC]{plot.variable}} function, setting 
#' \code{partial=TRUE}. Each data set is built with the 
...
#' 
#' \item \code{partial_pbc} - The \code{pbc} data from the Mayo Clinic trial in 
