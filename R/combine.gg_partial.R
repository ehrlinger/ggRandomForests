...
#'
#' time_index <- c(which(rfsrc_pbc$time.interest > 365)[1] - 1,
#'                 which(rfsrc_pbc$time.interest > 3 * 365)[1] - 1,
#'                 which(rfsrc_pbc$time.interest > 5 * 365)[1] - 1)
#'
#' partial_pbc <- parallel::mclapply(rfsrc_pbc$time.interest[time_index],
#'                   function(tm) {
