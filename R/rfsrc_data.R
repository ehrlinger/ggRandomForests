...
#' \item \code{rfsrc_airq} - randomForestS[R]C for the \code{airquality} data set.
#' \item \code{rfsrc_mtcars} - randomForestS[R]C for the \code{mtcars} data set.
...
#' \item \code{rfsrc_veteran} - randomForest[S]RC for the \code{veteran} data set
#'  (\code{randomForestSRC} package)  
#' }
#'   
#' @details 
...
#' 
#' \item \code{rfsrc_airq} - The \code{airquality} data set is from the New York State 
...
#' 
#' \item \code{rfsrc_mtcars} - The \code{mtcars} data was extracted from the 1974 Motor 
...
#' 
#' \item \code{rfsrc_veteran} - Veteran's Administration randomized trial of two treatment 
