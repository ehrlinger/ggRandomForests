...
#' @param x rf object
#' 
#' @export ggCompetingRisk.ggRandomForests
#' @export ggCompetingRisk

ggCompetingRisk.ggRandomForests <- function (x, plots.one.page = FALSE, ...) {
...
ggCompetingRisk <- ggCompetingRisk.ggRandomForests
