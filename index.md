...
It also covers [varPro](https://cran.r-project.org/package=varPro) (\>=
...
detection on unsupervised fits. Eight of the nineteen `gg_*` families
read a varPro object.
...
which read structure off a `uvarpro()` fit with no outcome — have their
own short vignette:
